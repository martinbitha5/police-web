...
export const config = {
  ...
  // sw.js : le service worker des notifications push est chargé par le
  // navigateur hors session, il doit être servi tel quel.
  matcher: ['/((?!_next/static|_next/image|favicon.ico|sw.js|api/|.*\\.(?:svg|png|jpe?g|gif|webp|ico|avif)$).*)'],
};
